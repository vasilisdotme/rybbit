...
Show a live visitor count on your own site with an embeddable iframe. Enable from the **Embed Widget** tab — this is independent of Public Analytics and only exposes the data the widget displays. See the [Embed Widget guide](/docs/embed-widget) for details.
